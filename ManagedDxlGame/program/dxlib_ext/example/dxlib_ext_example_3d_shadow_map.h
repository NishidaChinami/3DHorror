...
void gameMain(float delta_time) {
	...
	if (tnl::Input::IsKeyDown(eKeys::KB_A)) object->pos_.x -= 5;
	if (tnl::Input::IsKeyDown(eKeys::KB_D)) object->pos_.x += 5;
	if (tnl::Input::IsKeyDown(eKeys::KB_W)) object->pos_.z += 5;
	if (tnl::Input::IsKeyDown(eKeys::KB_S)) object->pos_.z -= 5;

	if (tnl::Input::IsKeyDown(eKeys::KB_UP))	object->pos_.y += 5;
	if (tnl::Input::IsKeyDown(eKeys::KB_DOWN))	object->pos_.y -= 5;
